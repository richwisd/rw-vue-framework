...
const localeOptions: Array<{ label: string; value: string; image: any }> = [
  { label: messages.cn.langs?.cn || 'CN', value: 'cn', image: cnImage },
  { label: messages.en.langs?.en || 'EN', value: 'en', image: enImage },
  { label: messages.tw.langs?.tw || 'TW', value: 'tw', image: twImage }
]
