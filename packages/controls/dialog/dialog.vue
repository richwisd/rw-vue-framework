...
.dialog-auto-form-buttons :deep(.dialog-form-button) {
  min-width: 80px;
}

/* 确保dialog中的按钮样式适配 */
.dialog-auto-form-buttons :deep(.el-button) {
  margin-left: 8px;
}

.dialog-auto-form-buttons :deep(.el-button:first-child) {
  margin-left: 0;
}
